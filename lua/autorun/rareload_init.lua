...
if SERVER then
    ...
    AddCSLuaFile("rareload/client/shared/cl_rareload_ui.lua")
    AddCSLuaFile("rareload/client/shared/depth_sorted_renderer.lua")
    AddCSLuaFile("rareload/ui/rareload_tool_ui.lua")
    ...
    AddCSLuaFile("rareload/client/saved_entity_display/SED_panel_renderer_context.lua")
    ...
    AddCSLuaFile("rareload/client/saved_entity_display/SED_pile.lua")
...
if SERVER then
    ...
    -- Debug system (v2) — must load before any core file that calls Debug.Log at include time
    ...
    include("rareload/core/vehicles/rareload_vehicles.lua")
...
elseif CLIENT then
    ...
    include("rareload/client/saved_entity_display/SED_pile.lua")
