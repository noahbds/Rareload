...
if SERVER then
    ...
    AddCSLuaFile("rareload/client/saved_entity_display/SED_panel_renderer_mini.lua")
    AddCSLuaFile("rareload/client/saved_entity_display/SED_panel_renderer_marker.lua")
