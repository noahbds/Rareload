...
local CONVAR_DEFS = {
    ...
    { "sv_rareload_auto_overwrite",        "0",   "On save, overwrite already-saved entities/NPCs that were moved or changed (off preserves their old saved state)",                "autoOverwriteModified" },
    ...
    { "sv_rareload_cleanup_only_saved",    "0",   "When cleanup on death is enabled, only remove entities/NPCs that were saved by Rareload instead of wiping the whole map",       "cleanupOnlySavedEntitiesOnDeath" },
