...
-- SED is a system to render 3d2d panels above saved entities and NPCs, showing detailed info about them.
-- It also includes an interaction system to allow players to interact with these panels to scroll through info
RARELOAD.SavedEntityDisplay = RARELOAD.SavedEntityDisplay or {}

SED = RARELOAD.SavedEntityDisplay

-- Lookup tables for saved entities
SED.SAVED_ENTITIES_BY_ID = {}
SED.SAVED_NPCS_BY_ID = {}
SED.TrackedEntities = {}
SED.TrackedNPCs = {}

-- Timing and cache management
...
-- Category definitions for entities
SED.ENT_CATEGORIES = {
