...
- **Found in game testing (panels)**: panels now sit just above their own model, the phantom when one shows, instead of v4's eye-height placement, which followed the viewer and left moved objects' phantoms without a panel. A pile's panel sits on its biggest model.
